...
def test_signal_post_still_works(client):
...
def test_room_post_still_works(client):
    response = client.post(
        "/room",
        data={"room": "Ghana Team Room", "name": "Visitor", "message": "Hello"},
    )
...
def test_flag_post_still_works(client):
    response = client.post("/flag", data={"team": "Ghana"})
...
def test_myworld_post_still_works(client):
    response = client.post(
        "/myworld", data={"nickname": "Visitor", "country": "Ghana"}
    )
