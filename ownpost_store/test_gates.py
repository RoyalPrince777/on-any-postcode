...
class Gates(unittest.TestCase):
 ...
 def test_event_bridge_privacy(self):
  ...
  pul=self.c.post('/api/event-bridge',headers=self.h,json={'kind':'ride_state','title':'Driver arriving','target_user_id':1}); self.assertEqual(pul.status_code,201); self.assertEqual(pul.json['channel'],'Pulse'); self.assertFalse(pul.json['public'])
