...
def init_db():
    ...
    for col, typ in [
        ("nickname","TEXT"),("password","TEXT"),("postcode","TEXT"),("borough","TEXT"),
        ("county_region","TEXT"),("country","TEXT"),("continent","TEXT"),
        ("weather_location","TEXT"),("verification_level","TEXT DEFAULT 'Starter'"),
    ...
    add_col(cur, "audit_logs", "username", "TEXT")
    add_col(cur, "audit_logs", "member", "TEXT")
    add_col(cur, "audit_logs", "created_at", "TEXT")

    cur.execute("""CREATE TABLE IF NOT EXISTS culture_posts(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        username TEXT, title TEXT, category TEXT, country TEXT, body TEXT, created_at TEXT
    )""")

    cur.execute("""CREATE TABLE IF NOT EXISTS artists(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        username TEXT, artist_name TEXT, genre TEXT, country TEXT, bio TEXT, link TEXT,
        status TEXT DEFAULT 'pending', created_at TEXT
    )""")

    cur.execute("""CREATE TABLE IF NOT EXISTS events(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        username TEXT, title TEXT, event_type TEXT, postcode TEXT, borough TEXT,
        country TEXT, venue TEXT, event_date TEXT, description TEXT,
        status TEXT DEFAULT 'pending', created_at TEXT
    )""")
    ...
    cur.execute("""CREATE TABLE IF NOT EXISTS trust_badges(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        username TEXT, requested_level TEXT, proof TEXT,
        status TEXT DEFAULT 'pending', created_at TEXT
    )""")

    cur.execute("""CREATE TABLE IF NOT EXISTS opportunities(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        username TEXT, source TEXT, description TEXT, amount REAL DEFAULT 0,
        currency TEXT DEFAULT 'GBP', status TEXT DEFAULT 'recorded', created_at TEXT
    )""")

    cur.execute("""CREATE TABLE IF NOT EXISTS payouts(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        username TEXT, recipient_name TEXT, reason TEXT, amount REAL DEFAULT 0,
        currency TEXT DEFAULT 'GBP', status TEXT DEFAULT 'pending',
        approved_by TEXT, paid_date TEXT, created_at TEXT
    )""")

    cur.execute("""CREATE TABLE IF NOT EXISTS approvals(
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        approval_type TEXT, record_id INTEGER, status TEXT DEFAULT 'pending',
        reviewer TEXT, notes TEXT, created_at TEXT
    )""")
...
def welcome():
    return render("""
    <div class='card hero'><h1>🌍 Your World Has Been Created</h1>
    <p class='green'>Welcome to OAP.</p>
    <a class='badge' href='/enter'>Enter My World</a>
    <a class='badge' href='/community'>Community</a>
    <a class='badge' href='/culture'>Culture</a>
    <a class='badge' href='/events'>Events</a></div>
    """)
