...
.menu-section h2{margin-bottom:5px}
...
def menu():
    ...
    <div class='grid'>
      <div class='card menu-section'><h2>🌍 Public World</h2>
      ...
      <div class='card menu-section'><h2>🌍 My World</h2>
      ...
      <div class='card menu-section'><h2>🏪 Commerce</h2>
      ...
      <div class='card menu-section'><h2>🧠 System</h2>
      <p><a href='/privacy'>Privacy & Trust</a></p><p><a href='/command_center'>Command Center</a></p><p><a href='/routes'>Routes</a></p><p><a href='/admin'>Admin</a></p></div>
    </div>
    """)
...
def command_center():
    ...
    conn.close()
    return render(f"<div class='card hero'><h1>🎯 Command Center</h1></div><div class='grid'><div class='card'><h2>{members}</h2><p>Members</p></div><div class='card'><h2>{businesses}</h2><p>Businesses</p></div><div class='card'><h2>{products}</h2><p>Products</p></div><div class='card'><h2>£{total:.2f}</h2><p>Opportunity Board</p></div></div>")
