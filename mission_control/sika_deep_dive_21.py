...
def status() -> dict[str, Any]:
    ...
    durable_credential = sika_bank_credential_store.readiness()
    ...
    return {
        ...
        "production_owner_session_route_software_ready": os_state["bank_app_security"]["production_session_route_software_ready"],
        "production_owner_session_route_live_proof": os_state["bank_app_security"]["production_session_route_live_proof"],
