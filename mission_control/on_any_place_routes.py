...
def map_intelligence_status():
    ...
    return _no_store(make_response(jsonify({
        ...
        "open_now_evaluator_ready": bool(readiness.get("open_now_evaluator_ready")),
        "event_inventory_source_proven": bool(readiness.get("event_inventory_source_proven")),
        "first_party_listing_photo_proven": bool(readiness.get("first_party_listing_photo_proven")),
        "business_owner_listing_tools_ready": bool(readiness.get("business_owner_listing_tools_ready")),
        "war_room_proof_runner_pass": bool(readiness.get("war_room_proof_runner_pass")),
