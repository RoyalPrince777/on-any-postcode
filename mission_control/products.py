...
SPOT_CAPABILITIES: tuple[dict[str, str], ...] = (
    ...
    {"id": "infrastructure", "name": "Map Intelligence", "owner": "OAP Map Intelligence", "purpose": "One intelligence surface for maps, roads, routes, weather, travel, movement, OAP Direct booking and delivery.", "status": "Location and weather live; real road rendering, booking and movement governed", "function": "Combines geographic road context, route planning, weather signals, travel choices, OAP Direct requests and movement/delivery awareness in one public surface.", "blocked_by": "Real road renderer must pass proof; first-party turn-by-turn routing, confirmed supplier bookings, payments and automatic dispatch remain locked until proven"},
