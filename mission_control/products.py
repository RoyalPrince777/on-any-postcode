...
SPOT_CAPABILITIES: tuple[dict[str, str], ...] = (
    ...
    {"id": "businesses", "name": "Local Businesses", "owner": "Business Registry", "purpose": "Business listings, offers and promotion.", "status": "Directory live", "function": "Separates discovery from transactions.", "blocked_by": "Certified merchant onboarding not connected"},
    ...
    {"id": "market", "name": "Market", "owner": "OAP Market", "purpose": "Products and Empire commerce.", "status": "Live owner-scoped listings", "function": "Authenticated sellers can publish listings; payments remain separate.", "blocked_by": "Checkout requires merchant certification and regulated payments"},
