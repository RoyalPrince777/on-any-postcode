...
PRODUCT_HIERARCHY: tuple[dict[str, str], ...] = (
    {"id": "the_spot", "name": "The Spot", "route": "/the-spot", "parent_id": "", "purpose": "The public Empire front door from local postcode life outward to world scale.", "owner": "OAP World"},
...
SPOT_CAPABILITIES: tuple[dict[str, str], ...] = (
    ...
    {"id": "arena", "name": "OAP Arena", "owner": "OAP Arena", "purpose": "One combined global arena for games, challenges, competition and recognition.", "status": "Session-scoped non-ranked Challenge Engine implemented", "function": "Runs server-authoritative questions with idempotent scoring, pause, resume, STOP and audit receipts.", "blocked_by": "Durable profiles, multiplayer, rankings, prizes, payments, external distribution and live A7 feeds remain locked"},
    ...
    {"id": "discovery", "name": "Explorer", "owner": "Explorer", "purpose": "Places, services and useful geographic information.", "status": "Location lookup live", "function": "Resolves place and postcode hierarchy with bounded provider calls.", "blocked_by": "Wider source-backed place coverage and opening-hours/event proof remain separate from current bounded navigation coverage"},
    {"id": "businesses", "name": "Local Businesses", "owner": "Business Registry", "purpose": "Business listings, offers and promotion.", "status": "Directory live; Founder-governed Certified Merchant role connected", "function": "Separates discovery from transactions and uses Founder-granted merchant certification for Market publishing.", "blocked_by": "Public self-service merchant onboarding remains intentionally unavailable; checkout still requires regulated payments"},
    {"id": "creators", "name": "Creators", "owner": "Creator Identity", "purpose": "Musicians, artists, talent and content creators.", "status": "Directory live", "function": "Provides creator discovery.", "blocked_by": "Certified Creator Identity and publishing workflow not connected"},
    {"id": "community-power", "name": "Empire Power", "owner": "Empire Power", "purpose": "Contribution, participation and Empire progress.", "status": "Read-only surface live", "function": "Links contribution awareness without copying its ledger.", "blocked_by": "Audited contribution ledger not connected"},
    {"id": "support", "name": "Empire Support", "owner": "Humanitarian Support", "purpose": "Local needs, resources and protected Empire assistance.", "status": "Read-only surface live", "function": "Shows the protected support entry point.", "blocked_by": "Safeguarding, certification and case privacy required"},
    {"id": "infrastructure", "name": "Map Intelligence", "owner": "OAP Map Intelligence", "purpose": "One intelligence surface for maps, roads, routes, weather, travel, movement, OAP Direct booking and delivery.", "status": "Location, weather, first-party road rendering and turn-by-turn software are live/proven within current routing coverage; booking and consequential movement stay governed", "function": "Combines geographic road context, route planning, weather signals, travel choices, OAP Direct requests and movement/delivery awareness in one public surface.", "blocked_by": "UK-wide owned routing coverage, source-backed events/open-now, confirmed supplier bookings, payments and automatic dispatch remain separately gated"},
    {"id": "market", "name": "Market", "owner": "OAP Market", "purpose": "Products and Empire commerce.", "status": "Live owner-scoped listings; Certified Merchant publishing gate connected", "function": "Founder-certified merchants can publish listings; checkout and payment capture remain separate.", "blocked_by": "Checkout still requires a compliant regulated payment route"},
    {"id": "music", "name": "OAP Music", "owner": "OAP Music / Media", "purpose": "The OAP-first music destination for artists, songs, albums, playlists and creator discovery.", "status": "Music destination registered; public surface ready", "function": "Positions OAP Music as the owned destination before any external platform handoff.", "blocked_by": "Full uploads, rights proof, monetisation and publishing workflow require authenticated Creator Identity and Human Authority approval"},
    {"id": "player", "name": "OAP Player", "owner": "OAP Music / Media", "purpose": "Own Spotify-style listening experience for cleared OAP tracks, playlists and radio handoff.", "status": "Player surface registered; stream-money dependency rejected", "function": "Streams build attention while money paths stay with membership, merch, events, direct support, creator stores and campaigns.", "blocked_by": "Playable audio requires owned, licensed or cleared uploads plus youth-safe moderation and rights records"},
    {"id": "radio", "name": "OAP Radio", "owner": "OAP Music / Media", "purpose": "The voice of OAP Music for live shows, postcode radio, culture, interviews, shout-outs and Safe Signals.", "status": "Radio surface registered; broadcast claims locked", "function": "Supports show schedules, cleared audio, Empire notices, creator campaigns and local business shout-outs.", "blocked_by": "Live broadcast, licensed music rotation and public streaming require approved licensing, rights proof and moderation"},
    {"id": "distribution", "name": "OAP Distribution", "owner": "OAP Music / Media", "purpose": "The release engine for music, video, podcasts, campaign pages, merch bundles, rights proof and royalty/value records.", "status": "Creator distribution surface registered; external delivery locked", "function": "Prepares OAP-first releases and campaigns while external platform delivery stays later through approved routes.", "blocked_by": "External Spotify, Apple Music, YouTube Music or TikTok delivery requires real aggregator/API/legal routes; no guaranteed earnings or stream-money claims"},
    ...
    {"id": "safety", "name": "Safety & Trust", "owner": "Trust", "purpose": "Reporting, Guardian protection and Empire standards.", "status": "Protection surface live", "function": "Explains fail-closed safety boundaries.", "blocked_by": "Authenticated reporting and escalation workflow not connected"},
    {"id": "identity", "name": "My World", "owner": "My World", "purpose": "One OAP identity and private personal space.", "status": "Managed identity and geographic profile live", "function": "Uses certified owner-scoped identity and location fields.", "blocked_by": "Optional higher-assurance certification remains separate"},
...
PUBLIC_SPOT_CAPABILITIES: tuple[dict[str, str], ...] = (
    ...
    {"source_id": "arena", "slug": "arena", "name": "OAP Arena", "purpose": "Play first-party challenges and progress from postcode to the Global Arena."},
    ...
    {"source_id": "infrastructure", "slug": "maps-weather-travel", "name": "On Any Place", "purpose": "Search a place, see source-bound weather, then move or book through OAP."},
    ...
    {"source_id": "radio", "slug": "radio", "name": "OAP Radio", "purpose": "Listen to shows, culture, interviews, shout-outs and public-safe Empire signals."},
    {"source_id": "distribution", "slug": "distribution", "name": "OAP Distribution", "purpose": "Prepare OAP-first releases, campaign pages, rights proof, merch bundles and value records."},
    {"source_id": "sika", "slug": "sika", "name": "SIKA", "purpose": "View contribution and trust-value records."},
    {"source_id": "safety", "slug": "safety", "name": "Safety & Trust", "purpose": "Find Empire standards and reporting support."},
