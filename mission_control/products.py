...
SPOT_CAPABILITIES: tuple[dict[str, str], ...] = (
    ...
    {"id": "infrastructure", "name": "Map Intelligence", "owner": "OAP Movement", "purpose": "One intelligence surface for maps, routes, weather, travel, movement, OAP Direct booking and delivery.", "status": "Location and weather live; booking and movement governed", "function": "Combines Atlas map context, route planning, weather signals, travel choices, OAP Direct requests and movement/delivery awareness in one surface.", "blocked_by": "Turn-by-turn routing, confirmed supplier bookings, payments and automatic dispatch remain locked until source, consent, identity and operational proof gates pass"},
...
PUBLIC_SPOT_CAPABILITIES: tuple[dict[str, str], ...] = (
    ...
    {"source_id": "infrastructure", "slug": "maps-weather-travel", "name": "Map Intelligence", "purpose": "Plan, book and move with maps, routes, travel, delivery and weather intelligence in one place."},
    ...
    {"source_id": "radio", "slug": "radio", "name": "OAP Radio", "purpose": "Listen to shows, culture, interviews, shout-outs and public-safe community signals."},
