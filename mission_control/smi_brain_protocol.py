...
BRAIN_PARTS: tuple[dict[str, object], ...] = (
    ...
    {"id": "prefrontal_cortex", "name": "Prefrontal Cortex", "role": "Judgement, restraint, priority and think-before-action control.", "does": "Stops rushed action, checks priority, blocks shortcuts and chooses 3, 7 or 21 stages.", "owns": ("judgement", "restraint", "priority", "risk depth"), "lead_agent": "Judgement Agent", "helper_agents": ("War Room", "Guardian", "Founder Authority"), "protocol_focus": "Mind stage 7 and Soul stages 15-21: risk level, judges and final escalation.", "needed_to_7": ("Wire Judgement runner", "record approval/blocked receipt", "prove one live 3/7/21 depth decision", "learn from over-action, under-action and Founder corrections")},
