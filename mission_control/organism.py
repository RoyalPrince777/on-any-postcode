...
CAPABILITY_ANATOMY: tuple[dict[str, Any], ...] = (
    ...
    {"id":"workspace_orchestrator","name":"Workspace Orchestrator","brain_regions":("thalamus","frontal_lobe","corpus_callosum"),"body_owner":"Living Kernel / Studio","protection_owner":"Guardian","memory_owner":"HRM","execution_owner":"Living Kernel after approval","status":"ready","missing":"No missing machine-side orchestration function; consequential execution remains separately Human-Authority-gated by design.","consequential_execution":False},
    ...
    {"id":"live_build_preview","name":"Live Build Preview Engine","brain_regions":("frontal_lobe","occipital_lobe","parietal_lobe","cerebellum"),"body_owner":"Builder / Infrastructure","protection_owner":"Guardian + Green Gate","memory_owner":"HRM build receipts","execution_owner":"Isolated preview runtime","status":"ready","missing":"No missing browser-isolated machine-side preview function; production deploy and arbitrary generated backend execution remain separately governed by design.","consequential_execution":False},
