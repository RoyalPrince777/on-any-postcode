...
def evidence_contract(health: dict[str, Any] | None) -> str:
    ...
    return (
        ...
        "materially changes the answer or safety boundary. Never reveal hidden chain-of-thought, "
        "internal token reasoning or private scratch work. When useful, expose only safe stage/status "
        "telemetry such as Understand → Verify → Challenge → Decide → Answer, plus evidence, "
        "assumptions, unknowns, confidence, risks and next action. "
