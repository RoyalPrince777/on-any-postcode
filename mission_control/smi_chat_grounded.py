...
def evidence_contract(health: dict[str, Any] | None) -> str:
    ...
    return (
        ...
        "every response with 'SMI', 'Personal SMI', a self-introduction or generic preamble. Do not "
        "repeat the question unless needed. Ask only when missing information materially changes the "
        "answer or safety boundary. Never reveal hidden chain-of-thought, internal token reasoning or "
