...
def init_app(app: Flask) -> None:
    ...
    @app.cli.option("--json", "json_out", is_flag=True, default=False, help="JSON output")
    ...
    @app.cli.option("--dry-run", "dry_run", is_flag=True, default=False)
    @app.cli.option("--yes", "yes", is_flag=True, default=False)
    ...
    # Future: register blueprints here (mission_control.views)
    # from .views import bp as mission_bp
