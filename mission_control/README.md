...
- `agents.py`: one canonical registry for seven OAP-owned Intelligence
  families, confirmed agents, Soul–Mind–Body passports and separately scoped
...
- `organism.py`: canonical Digital Organism registry and duplicate-boundary
  ...
  the seven Intelligence worlds, agent Soul–Mind–Body, and Human Authority as
