...
app = Flask(__name__)
app.secret_key = "change_this_oap_5014_logos_secret"
...
COUNCIL = {
    "GPT Architect": ("Architecture, orchestration, system design", "GPT", "⬡"),
    "Claude Chancellor": ("Privacy, governance, safety, policy", "CL", "⚖"),
    "Gemini Archivist": ("Memory, long context, ecosystem review", "GM", "◈"),
    "Kimi Expansion": ("Deep decomposition, scaling, roadmap", "KM", "↗"),
    "Grok Challenger": ("Stress-test, objections, rapid challenge", "GX", "✦"),
    "HRM Record Keeper": ("Logs, lessons, audit, memory review", "HRM", "▣"),
    "Sovereign Veto": ("Final human approval before real-world action", "SV", "👑")
}
...
.logo{width:64px;height:64px;border:2px solid #ffd76b;border-radius:50%;display:flex;align-items:center;justify-content:center;font-weight:bold;color:#ffd76b;background:#1d1808}
.logo small{display:block;font-size:11px;color:#fff8e6}
...
<nav>
<a href="/">Gateway</a>
<a href="/council">Council Logos</a>
...
def home():
    ...
    <p>Fast logo system: lightweight text/symbol badges, no heavy image files.</p>
    </div>
    """)

@app.route("/council")
def council():
    html = "<div class='card'><h2>AI Council Logos</h2><div class='grid'>"
    for name, data in COUNCIL.items():
        role, initials, mark = data
        html += f"""
        <div class='card'>
          <div class='row'>
            <div>
