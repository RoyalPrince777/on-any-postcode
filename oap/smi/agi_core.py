...
_DOMAIN_RULES: tuple[dict[str, object], ...] = (
    ...
    },
    {
        ...
        "kind": "cross_system_capability",
        "keywords": (
            "life", "education", "learn", "learning", "adult", "youth",
            "trade", "trades", "apprentice", "career", "job", "work",
            "money", "budget", "business", "law", "home", "parenting",
            "skill", "school", "profession",
        ),
    },
    {
        "id": "movement",
        ...
        "kind": "cross_system_capability",
        "keywords": (
            "move", "movement", "route", "routing", "travel", "traffic",
            "drive", "walking", "walk", "cycle", "cycling", "train", "bus",
            "delivery", "logistics", "navigation", "road", "journey", "map",
            "parking", "transport",
        ),
    },
    {
        ...
        "kind": "intelligence_world",
        "keywords": (
            "community", "community power", "president", "vice president",
            "leadership", "public service", "local service", "vote", "civic",
        ),
    },
    {
        "id": "civilisation",
        ...
        "kind": "intelligence_world",
        "keywords": (
            "civilisation", "civilization", "history", "institution", "culture",
            "society", "heritage", "human progress",
        ),
    },
    {
        "id": "matrix",
        ...
        "kind": "intelligence_world",
        "keywords": (
            "code", "technical", "architecture", "system", "database", "api",
            "deploy", "software", "strategy", "simulation", "problem solving",
        ),
    },
    {
        "id": "akan",
        ...
        "kind": "intelligence_world",
        "keywords": (
            "akan", "akyem", "adinkra", "ghana", "begoro", "koradaso",
        ),
    },
    {
        "id": "animal",
